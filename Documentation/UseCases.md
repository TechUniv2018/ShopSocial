...
6. A customer can **sign in** to his account on the website.
7. A customer can **add products** to her cart.
8. A customer can **remove products** from her cart.
9. A customer can **checkout and pay** for the items in her cart.
10. A customer can **chat with another shopper** on the website whilst shopping on the website.
11. A customer can **share her activities on screen with another shopper** on the website.
